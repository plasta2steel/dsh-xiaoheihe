...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
     ...
     */
    function CommentThread({ item, onErr }) {
                ...
                detail.comments && detail.comments.length
                  ? h("div", null,
                      detail.comments.map((it) =>
                        h(CommentThread, { key: it.id, item: it, onErr: runErr }),
                      ),
                    )
